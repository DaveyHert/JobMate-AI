...
class FieldDetector {
  detectFieldType(element) {
    ...
    for (const [fieldType, config] of Object.entries(fieldTypes)) {
      let score = 0;
      let method = '';
...
class AutoFillEngine {
  ...
  addFilledFieldIndicator(element) {
...
function createAutoFillEngine() {
  return new AutoFillEngine(UserProfile);
}

// Make it available globally
window.createAutoFillEngine = createAutoFillEngine;
